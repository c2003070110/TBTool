...
var autocompleteUrl = "http://133.130.114.129/myphp/mydaigou/autocomplete.php";
$(function() {
...
?>
  <ul class="list-group list-group-horizontal">
    ...
    <li class="list-group-item"><a href="/myphp/mydaigou/itemlist.php?buyer=<?php echo $buyer ?>&status=gouru">已购入</a></li>
    <li class="list-group-item"><a href="/myphp/mydaigou/itemlist.php?buyer=<?php echo $buyer ?>&status=zaitu">已在途</a></li>
    <li class="list-group-item"><a href="/myphp/mydaigou/itemlist.php?buyer=<?php echo $buyer ?>&status=fahuo">已发货</a></li>
    <li class="list-group-item"><a href="/myphp/mydaigou/itemlist.php?buyer=<?php echo $buyer ?>&status=compl">已完結</a></li>
