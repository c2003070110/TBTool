...
//        }
    ...
    protected void composeBaobeiCateProps(GoodsObject item, BaobeiPublishObject obj) {
        ...
        // 宝贝属性
        cateProps += TaobaoUtil.composeBaobeiCateProps(item.colorList, item.sizeList, taobaoColors, taobaoSizes);
    ...
    protected void composeBaobeiSkuProps(GoodsObject item, BaobeiPublishObject obj) {
        ...
        String skuProps = TaobaoUtil.composeBaobeiSkuProps(item.colorList, item.sizeList, taobaoColors, taobaoSizes,obj.price);
