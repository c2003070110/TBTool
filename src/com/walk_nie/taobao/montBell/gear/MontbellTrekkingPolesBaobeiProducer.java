...
public class MontbellTrekkingPolesBaobeiProducer extends BaseBaobeiProducer{
...
//                        +  ";";
    ...
    public MontbellTrekkingPolesBaobeiProducer addScanCategory(String scanCategoryId) {
