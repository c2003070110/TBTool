...
//        }
    ...
    public static String getExtraMiaoshu() {
        ...
        miaoshu.append("<li style=\"padding:10.0px;\"><span style=\";color:red;font-weight:bold\">关税：</span> 本店是代购，不报关不包税。不幸被抽查产生关税，<span style=\";color:red;font-weight:bold\">由买家通关报关。关税买家自己承担。代办费也是由买家承担</span></li>");
