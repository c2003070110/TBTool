...
public class PanBaidu  {
    ...
    protected  void execute(String user,String pass) throws IOException {
    	...
    	while(true){
            System.out.println("Change other FOLDER to generate link!");
        	mywait();
        	if(!loopFlag){
        		break;
        	}
	...
	protected  void generateHref(WebDriver driver) throws IOException {
        ...
        for(WebElement element : list){
        	...
        	element.findElement(By.cssSelector("a[data-button-id=\"b51\"]")).click();
        	
//        	System.out.println(driver.getPageSource());
        	mywait();
//        	System.out.println(driver.getPageSource());
        	WebElement dialogRoot = driver.findElement(By.cssSelector("div[id=\"share\"]"));
        	
        	WebElement dialogHeader = dialogRoot.findElement(By.className("dialog-header"));
        	String fileName = dialogHeader.findElement(By.tagName("h3")).getText();
            System.out.println("Generating Link for" + fileName);
        	fileName = fileName.replace("分享文件(夹):", "");
        			
        	WebElement closeBtn = dialogHeader.findElement(By.cssSelector("div[class=\"dialog-control\"]"));
        	
        	WebElement dialogBody = dialogRoot.findElement(By.cssSelector("div[class=\"dialog-body\"]"));
        	WebElement dialogFoot = dialogRoot.findElement(By.cssSelector("div[class=\"footer\"]"));
        	...
        	WebElement url = linkInfo.findElement(By.cssSelector("div[class=\"url\"]")).findElement(By.tagName("input"));
        	String urlTxt = url.getAttribute("value");
        			
        	WebElement password = linkInfo.findElement(By.cssSelector("div[class=\"password\"]")).findElement(By.tagName("input"));
	...
	protected void mywait() throws IOException {
		while (true) {
			System.out.print("ready for continue? ENTER/N");
